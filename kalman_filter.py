...
class KalmanFilter(object):
    ...
    def __init__(self):
        ...
        self.Q = np.eye(self.u.shape[0])/100  # process noise matrix
        self.R = np.zeros(self.b.shape[0])  # observation noise matrix
